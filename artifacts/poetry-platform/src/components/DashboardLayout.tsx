...
export function DashboardLayout({ children }: { children: ReactNode }) {
  ...
  const isSystemAdmin =
    ...
    user?.role === "admin";
  const isAuditOnlyUser = user?.role === "audit" || user?.role === "audit_user";
  ...
  const navItems: { href: string; label: string; icon: ReactNode; show: boolean }[] = [
    ...
    },
    {
      ...
      show: user?.role === "audit" || user?.role === "audit_user",
    },
    {
      href: "/dashboard/reports",
      label: "Reports",
      icon: <LayoutIcon path="M9 17v-6m3 6V7m3 10v-3M5 3h14a2 2 0 012 2v14l-4-2-4 2-4-2-4 2V5a2 2 0 012-2z" />,
    ...
    },
    {
      ...
      show: !isSystemAdmin && !isAuditOnlyUser,
    },
  ];
