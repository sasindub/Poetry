...
export default function HomePage() {
  ...
  const poemTypes = [
    { key: "nabati", title: t("nabati"), desc: t("nabatiDesc"), icon: "✦", color: "from-amber-900/40 to-amber-800/20" },
    { key: "classical", title: t("classical"), desc: t("classicalDesc"), icon: "✦", color: "from-teal-900/40 to-teal-800/20" },
    { key: "modern", title: t("modern"), desc: t("modernDesc"), icon: "✦", color: "from-indigo-900/40 to-indigo-800/20" },
  ];
    ...
    <PublicLayout>
      ...
      <section ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <motion.div
            ...
            style={{
              backgroundImage: "radial-gradient(ellipse at 30% 50%, rgba(200, 169, 110, 0.3) 0%, transparent 50%), radial-gradient(ellipse at 70% 30%, rgba(26, 122, 107, 0.2) 0%, transparent 50%)",
            }}
          />
        ...
        >
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-gold/30 bg-gold/5 text-gold text-xs font-medium mb-6 tracking-wider"
          >
          ...
          <motion.div
            ...
            className="mb-4"
          >
            <p className="text-5xl md:text-7xl font-arabic text-gold/80 leading-tight" dir="rtl">
              ديوان الوطن
            </p>
          </motion.div>
          ...
          >
            <Link
              href="/submit"
              className="px-8 py-3.5 rounded-xl gold-gradient text-navy font-bold text-base hover:opacity-90 transition-all shadow-lg shadow-gold/20 hover:shadow-gold/40 hover:-translate-y-0.5"
            >
              {t("submitNow")}
            </Link>
            <a
              href="#about"
              className="px-8 py-3.5 rounded-xl border border-gold/30 text-gold font-semibold text-base hover:bg-gold/10 transition-all"
            >
              {t("learnMore")}
            </a>
          </motion.div>
      ...
      <section id="about" className="py-24 max-w-7xl mx-auto px-4">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <ScrollReveal>
            <div>
              <div className="text-xs text-gold font-semibold tracking-widest uppercase mb-3">
                {t("about")}
              </div>
            ...
            {[
              ...
              <ScrollReveal key={i} delay={i * 0.15}>
                <div className="relative">
                  ...
                  <div className="glass-panel rounded-xl p-6 h-full border border-gold/10 hover:border-gold/30 transition-colors">
          ...
          {poemTypes.map((type, i) => (
            <ScrollReveal key={type.key} delay={i * 0.15}>
              <motion.div
                ...
                className={`relative rounded-2xl p-8 bg-gradient-to-br ${type.color} border border-gold/10 hover:border-gold/30 transition-colors overflow-hidden`}
              >
                <div className="absolute top-4 right-4 text-gold/20 text-6xl font-display font-bold">{String(i + 1).padStart(2, "0")}</div>
                <div className="text-gold text-2xl mb-4">{type.icon}</div>
      ...
      <section className="py-24 max-w-4xl mx-auto px-4 text-center">
        <ScrollReveal>
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-br from-gold/10 via-card to-accent/10 border border-gold/20 rounded-3xl" />
            <div className="relative z-10">
              ...
              <Link
                href="/submit"
                className="inline-flex items-center gap-2 px-10 py-4 rounded-xl gold-gradient text-navy font-bold text-lg hover:opacity-90 transition-all shadow-lg shadow-gold/25 hover:-translate-y-0.5"
              >
                {t("submitNow")}
