...
import royalBorderImageSrc from "@/assets/images/border.png";
const royalBorderImage = typeof royalBorderImageSrc === "string" ? royalBorderImageSrc : (royalBorderImageSrc as any).src;
...
export default function HomePage() {
  ...
  const stats = { totalSubmissions: 247, approved: 86, totalJuryMembers: 12 };
