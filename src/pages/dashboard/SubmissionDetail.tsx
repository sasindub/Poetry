...
export default function SubmissionDetail() {
  ...
  function confirmJuryForm() {
    ...
    showToast("Jury form confirmed. Moved to Assign stage.");
    return true;
  }
  ...
  function dispatchToJury() {
    ...
    setSubmission((prev: any) => ({ ...prev, status: "under_jury_review" }));
    ...
    showToast(`Assigned ${selectedJury.length} jury member(s). Moved to Jury stage — deadline: ${deadline}h`);
    return true;
  }
            ...
            >
              ...
              <div className="p-6 space-y-5">
                ...
                <div>
                  ...
                  <p className="text-xs text-foreground/30 mt-1.5">Default: 48 hours</p>
                </div>
