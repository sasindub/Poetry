          ...
          >
            ...
            >
              ...
              <div className="p-6 space-y-6">
                <p className={`text-xs flex items-center gap-2 px-3 py-2 rounded-lg border ${
                  isDark
                      ...
                      className={`flex-1 py-3 rounded-xl font-semibold text-sm transition-all border-2 ${
                        decisionType === "accept"
                          ...
                          : (isDark
                              ...
                              : "border-green-400 text-green-900 hover:bg-green-50")
                      }`}
                    >
                      ✓ {lang === "ar" ? "قبول" : "Accept"}
                    </button>
                      ...
                      className={`flex-1 py-3 rounded-xl font-semibold text-sm transition-all border-2 ${
                        decisionType === "reject"
                          ...
                          : (isDark
                              ...
                              : "border-red-400 text-red-900 hover:bg-red-50")
                      }`}
                    >
                      ✗ {lang === "ar" ? "رفض" : "Reject"}
                    </button>
